...
var createResource = function createResource(data) {
  ...
  return resources.save(data).then((resource) => {
    ...
    return resources.update(resource, meta).then((result) => {
...
var createGraphNode = function createGraphNode(
  resourceId,
  isResource,
  path,
  metaId
  ...
  var data = _.merge(
    {},
    { resource_id: resourceId, is_resource: isResource, path, meta_id: metaId }
  );
              ...
              return edges
                ...
                .then(function () {
                  ...
                  return Promise.map(gNodes, function (rockGnode) {
                    var m = _.findKey(
                      rocksResource['rocks-index'],
                      rockGnode.resource_id
                    );
                    return edges.save({
                      _to: rockGnode._id,
