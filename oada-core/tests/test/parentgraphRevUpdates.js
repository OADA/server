...
describe('Check Rev Update for a Link Res (Parent Graph)', () => {
  ...
  describe('Task: HTTP responses for the PUT request', () => {
    ...
    describe('http_get_error_response_after', () => {
      it('should be null', () => {
        trace('http_get_error_response_after: ' + http_get_error_response_after)
    ...
    describe('http_update_rock_err', () => {
      it('should be null', () => {
        trace('http_update_rock_err: ' + http_update_rock_err)
    ...
    describe('http_get_updated_rock_err', () => {
      it('should be null', () => {
        trace('http_get_updated_rock_err: ' + http_get_updated_rock_err)
